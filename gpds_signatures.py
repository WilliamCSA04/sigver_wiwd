...
def get_skilled(path, number_of_signatures):
    signatures = __get_signatures(path)
    filtered_signatures = __filter_signatures(filter_forgery, signatures, number_of_signatures)
    return filtered_signatures
...
def __filter_signatures(filter_method, signatures, number_of_signatures):
